...
void Mesh::load(string filename, GLuint type) {
	...
	glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, sizeof(Vtx), (GLvoid*)sizeof(vec3));
	glEnableVertexAttribArray(2);
	glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE, sizeof(Vtx), (GLvoid*)(sizeof(vec3) + sizeof(vec2))); //origin: 2
	glEnableVertexAttribArray(3);
	glVertexAttribIPointer(3, 1, GL_UNSIGNED_INT, sizeof(Vtx), (GLvoid*)(sizeof(vec3) + sizeof(vec2) + sizeof(vec3)));
